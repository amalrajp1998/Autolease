...
class _MyAccountState extends State<MyAccount> {
  ...
  Future<http.Response> updateProof() async {
    final http.Response uploadimage = await http.post(
      ...
      'https://admin.autolease-uae.com/autolease/user/imageDetails',
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
  ...
  Future<http.Response> updateUser() async {
    if (proofImageUrl != null) {
      ...
      final http.Response statuscode = await http.put(
          ...
          'https://admin.autolease-uae.com/autolease/user/update/$userId',
          headers: <String, String>{
            'Content-Type': 'application/json; charset=UTF-8',
            'Authorization': 'Bearer ' + Token
          },
...
// }
  ...
  Future<http.Response> getUser() async {
    ...
    final http.Response response2 = await http.get(
      ...
      'https://admin.autolease-uae.com/autolease/users/user?mobile=$Number',
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer ' + Token
      },
...
///////
  ...
  String url = 'https://admin.autolease-uae.com/autolease/user/uploadProof';
